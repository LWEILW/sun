  ...
  <div id="wrap" :style="{ height: screenHeight + 'px' }">
    <div id="main" :style="{ top: nowTop + 'px' }">
      <ul id="pageUl" type="circle">
        <li id="pageUlLi1" class="pageUlLi" :class="{'active': curIndex == 1}">-简历-</li>
        <li id="pageUlLi2" class="pageUlLi" :class="{'active': curIndex == 2}">-关于我-</li>
        <li id="pageUlLi3" class="pageUlLi" :class="{'active': curIndex == 3}">-作品-</li>
        <li id="pageUlLi4" class="pageUlLi" :class="{'active': curIndex == 4}">-项目-</li>
        <li id="pageUlLi5" class="pageUlLi" :class="{'active': curIndex == 5}">-联系方式-</li>
      </ul>
      ...
      <div style="background-color: #8a6d3b" id="page3" class="page">
        <div>
          <h2>关于我们</h2>
          <p>起飞页不仅是一个方便快捷的构建网站的自助建站平台，更重要的是，我们为中国用户提供了更多贴心的服务：
            网站备案、自动备份、快速恢复以及网站代建服务。我们使用了国内和香港最好的网络和云服务器，确保您的网站能够快速完美的呈现在访客面前。</p>
        </div>
      </div>
